...
////////////////////////////////////////////////////////////////////////////////
 ...
 #if PX4FLOW == ENABLED
   #if CONFIG_HAL_BOARD == HAL_BOARD_APM2
       static AC_OpticalFlowPX4 ofPX4(g.pid_optflow_pitch);
	#elif	CONFIG_HAL_BOARD == HAL_BOARD_PX4
	   static AC_OpticalFlowPX4_Pixhawk ofPX4(g.pid_optflow_pitch);
   #endif
 #endif
...
//#if CONFIG_HAL_BOARD == HAL_BOARD_PX4
//    static AC_OpticalFlowPX4_Pixhawk ofPX4;
...
static void update_opticalFlow(){ 
   //if(control_mode==CIRCLE){
     ofPX4.update();
   //}
} 
static void ofloiter_run2(){
int16_t target_roll, target_pitch;
   ...
   ofPX4.get_sp_vel(g.rc_2.control_in,g.rc_1.control_in,vel_target_rot.x,vel_target_rot.y);
   target_yaw_rate = get_pilot_desired_yaw_rate(g.rc_4.control_in);
    ...
    if (ap.land_complete) {
        ...
        ofPX4.get_of_angles(vel_target_rot.x,vel_target_rot.y,target_pitch,target_roll,G_Dt);
